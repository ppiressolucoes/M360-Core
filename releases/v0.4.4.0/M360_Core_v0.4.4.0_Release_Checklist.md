# M360 Core v0.4.4.0 / v0.4.4.1 — Release Checklist
...
| Item | Status |
|---|---|
| Versão WordPress header `0.4.4.1` | Pendente validação final |
| Constante `M360_CORE_VERSION` `0.4.4.1` | Pendente validação final |
...
## 6. Validação de workflow

- Executar workflow `Build M360 Core Plugin ZIP`.
- Informar versão `0.4.4.1`.
- Confirmar artifact `m360-core-v0.4.4.1.zip`.
- Baixar ZIP.
...
## 8. Critério de pronto para merge
