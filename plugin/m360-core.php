<?php
/**
 * Plugin Name: M360 - Core Editorial
 * Description: Sistema editorial e de navegação para WordPress com independência de tema M360 Core.
 * Version: 0.7.4.0.17
 * Author: M360
...
if (!defined('M360_CORE_VERSION')) { define('M360_CORE_VERSION', '0.7.4.0.17'); }
