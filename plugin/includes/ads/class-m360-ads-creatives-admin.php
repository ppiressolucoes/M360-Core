...
final class M360_Ads_Creatives_Admin
{
    ...
    public static function render_creatives(): void
    {
        ...
        echo '<p>Biblioteca exclusiva de criativos do Ads Manager. Use preferencialmente URLs dentro de <code>/uploads/m360-ads/</code>.</p>';
        echo '<table class="widefat striped"><thead><tr><th>Preview</th><th>Nome</th><th>Campanha</th><th>Tipo</th><th>Idioma</th><th>Dispositivo</th><th>Tamanho</th><th>Status</th><th>Acoes</th></tr></thead><tbody>';
        foreach ($rows as $row) {
