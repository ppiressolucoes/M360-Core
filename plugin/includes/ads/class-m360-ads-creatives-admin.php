...
final class M360_Ads_Creatives_Admin
{
    ...
    {
        add_submenu_page(null, 'Criativos', 'Criativos', 'manage_options', 'm360-ads-creatives', [self::class, 'render_creatives']);
        add_submenu_page(null, 'Novo Criativo', 'Novo Criativo', 'manage_options', 'm360-ads-creative-new', [self::class, 'render_form']);
    }
