...
Este índice organiza os documentos mestres, documentos de módulo, sprints, releases e operações do M360 Core.

A partir da Sprint `v0.4.4.0 — M360 AdSense Ready`, a **M360 Inventory Library** passa a integrar o conjunto de documentos oficiais da arquitetura da plataforma.
...
|---|---|---|
| Sprint v0.4.4.0 — M360 AdSense Ready | `docs/02-sprints/Sprint_v0.4.4.0_M360_AdSense_Ready.md` | Planejamento e aceite da preparação AdSense Ready |
